          ...
          <div className="footer-grid">
            ...
            <div className="footer-column">
              ...
              <div className="social-links">
                <a href="https://www.instagram.com/inspira.ar/" aria-label="Instagram" className="social-link">
                ...
                <a href="https://www.linkedin.com/company/inspira-recursos-humanos/posts/?feedView=all" aria-label="LinkedIn" className="social-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
